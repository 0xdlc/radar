...
class transformer(object):
    ...
    it can read data from filfrom utils.set_details import set_detailes (giving it the directory name it will iterate through the files itself) or straight from an object
